...
spec = (
    ...
    # Plan I3 additive knobs (L2 width, L3 lateral channel, L5 yaw cap); 0 = off.
    ("NAVRL_SPEED_GOVERNOR_WIDTH_PER_MPS", 0.0, False),
    ("NAVRL_SPEED_GOVERNOR_WIDTH_PER_OPEN_M", 0.0, False),
    ("NAVRL_SPEED_GOVERNOR_WIDTH_OPEN_REF_M", 1.2, True),
    ("NAVRL_SPEED_GOVERNOR_WIDTH_MAX_M", 3.0, True),
    ("NAVRL_SPEED_GOVERNOR_LATERAL_MARGIN_M", 0.0, False),
    ("NAVRL_SPEED_GOVERNOR_LATERAL_SPAN_M", 2.0, True),
    ("NAVRL_SPEED_GOVERNOR_LATERAL_FLOOR_MPS", 1.0, False),
    ("NAVRL_SPEED_GOVERNOR_YAW_CAP_RADPS", 0.0, False),
    ("NAVRL_SPEED_GOVERNOR_YAW_CAP_MARGIN_M", 1.0, True),
)
values = []
...
read -r NAVRL_SPEED_GOVERNOR_FIXED_MPS NAVRL_SPEED_GOVERNOR_FREE_MPS \
    ...
    NAVRL_SPEED_GOVERNOR_BRAKE_MPS2 NAVRL_SPEED_GOVERNOR_REACTION_S \
    NAVRL_SPEED_GOVERNOR_WIDTH_PER_MPS NAVRL_SPEED_GOVERNOR_WIDTH_PER_OPEN_M \
    NAVRL_SPEED_GOVERNOR_WIDTH_OPEN_REF_M NAVRL_SPEED_GOVERNOR_WIDTH_MAX_M \
    NAVRL_SPEED_GOVERNOR_LATERAL_MARGIN_M \
    NAVRL_SPEED_GOVERNOR_LATERAL_SPAN_M NAVRL_SPEED_GOVERNOR_LATERAL_FLOOR_MPS \
    NAVRL_SPEED_GOVERNOR_YAW_CAP_RADPS NAVRL_SPEED_GOVERNOR_YAW_CAP_MARGIN_M <<< "${GOVERNOR_VALUES}"
...
export NAVRL_SPEED_GOVERNOR_WIDTH_PER_MPS NAVRL_SPEED_GOVERNOR_LATERAL_MARGIN_M
export NAVRL_SPEED_GOVERNOR_WIDTH_PER_OPEN_M NAVRL_SPEED_GOVERNOR_WIDTH_OPEN_REF_M
export NAVRL_SPEED_GOVERNOR_WIDTH_MAX_M
export NAVRL_SPEED_GOVERNOR_LATERAL_SPAN_M NAVRL_SPEED_GOVERNOR_LATERAL_FLOOR_MPS
export NAVRL_SPEED_GOVERNOR_YAW_CAP_RADPS NAVRL_SPEED_GOVERNOR_YAW_CAP_MARGIN_M
