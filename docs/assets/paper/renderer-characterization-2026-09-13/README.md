...
Six figures for the RC track. Every number plotted is read from a committed `summary.json` under
...
| `rc-r6-evidence-map` | What each experiment established, and the explicit `NOT_TESTED` link to the closed D8b result. |
