...
| Current ETH notice and ZIP bundling | PASS | [notice](../results/eth_ds5_intake_2026-09-10/THIRD_PARTY_NOTICE.md), [member-preservation receipt](../results/eth_ds5_intake_2026-09-10/archive_notice_receipt.json) |
...
| No raw datasets | BLOCKED | No tracked datasets/ path, but derived images/archives exist elsewhere; path check is insufficient |
