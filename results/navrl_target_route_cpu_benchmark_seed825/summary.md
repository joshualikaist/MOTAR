...
0.25 m route grid, 0.2064 m all-orientation target support, 0.45 m tracking reserve,
...
connectivity. An independent 20-layout same-inflation topology probe found 300-bar
...
claim. GPU/PhysX tracking, contact rate, reset stalls, and policy effects remain unmeasured.
