...
ROOTS = {
    ...
    "RA_drift_probe_T1_s521": "results/navrl_grid_r0_drift_probe_T1_seed521",
    "RB_seedrep_s527": "results/navrl_grid_r1_seedrep_ep25000_s527",
    "RB_seedrep_s531": "results/navrl_grid_r1_seedrep_ep25000_s531",
    "RB_crosstree_s523": "results/navrl_grid_r3_crosstree_s523",
}
    ...
    for row in data:
        for key in row:
            if key not in fields:
                fields.append(key)
    out_dir = REPO / "results" / "verification_export_2026-09-07"
