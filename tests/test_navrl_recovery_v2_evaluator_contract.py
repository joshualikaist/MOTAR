        ...
        for speed in GATE.SPEEDS:
            for bars in GATE.DENSITIES:
                ...
                row = {
                    ...
                    "contact_step_fraction": 0.0, "off_local_infeasible_fraction": 0.0,
                    "recovery_local_invalidation_fraction": 0.0,
    ...
    def test_probe_contract_uses_raw_verified_lookup_and_exact_schema_pair(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with mock.patch.object(
                GATE.BRAKE_VERIFY, "verify_receipt",
                return_value={"summary": {"measured_speed_to_p95_lookup": lookup}},
            ):
