...
def run(output: Path) -> Dict[str, Any]:
    ...
    try:
        ...
        for speed in probe.REGISTERED_SPEEDS:
            ...
            command = [sys.executable, str(root / "tools/probe_navrl_physical_target_braking.py"), "--output", str(cell_path), "--speed", format(speed, ".1f"), "--envs", str(probe.REGISTERED_ENVS), "--_single-speed"]
